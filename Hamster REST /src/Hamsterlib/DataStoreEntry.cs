...
namespace HSRM.CS.DistributedSystems.Hamster
{
    public class DataStoreEntry
    {
        ...
        public DataStoreEntry(int id, string ownerName, string hamsterName, ushort treats)
        {
            ID = id;
            OwnerName = ownerName;
        ...
        [XmlElement("price")]
        public ushort Price { get; set; } = HamsterManagement.BasePrice;

        [XmlElement("treats")]
        public ushort Treats { get; set; } = 0;
